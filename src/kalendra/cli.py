...
def cmd_init(args) -> int:
    db = _database(args)
    print(f"Base initialisée : {db.path}")  # noqa: T201
    return 0
...
def cmd_user_add(args) -> int:
    ...
    print(f"Utilisateur « {args.username} » créé (id={user_id}).")  # noqa: T201
    return 0
...
def cmd_user_list(args) -> int:
    ...
    for user in db.list_users():
        ...
        print(f"{user['id']:>3}  {flag}  {user['username']:<20} agendas: {calendars}")  # noqa: T201
    return 0
...
def cmd_user_passwd(args) -> int:
    ...
    print("Mot de passe mis à jour.")  # noqa: T201
    return 0
...
def cmd_user_rm(args) -> int:
    ...
    print("Utilisateur supprimé.")  # noqa: T201
    return 0
...
def cmd_calendar_add(args) -> int:
    ...
    print(f"Agenda créé : /calendars/{args.username}/{args.name}/")  # noqa: T201
    print(f"Flux ICS   : /feed/{calendar['feed_token']}.ics")  # noqa: T201
    return 0
...
def cmd_calendar_token(args) -> int:
    ...
    print(f"/feed/{token}.ics")  # noqa: T201
    return 0
...
def cmd_calendar_rm(args) -> int:
    ...
    print("Agenda supprimé.")  # noqa: T201
    return 0
